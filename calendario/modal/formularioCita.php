          ...
          <form id="Formajax" method="">
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="number"  name="pacCedula" id="Cedula" onpaste="setTimeout(() => this.value = this.value.slice(0, 8), 0)" onkeydown="return event.keyCode !== 69" class="form-control" pattern="[0-9]*" oninput="this.value = this.value.slice(0, 8),fetchData()">
              </div>
              <div class="col-md-6">
