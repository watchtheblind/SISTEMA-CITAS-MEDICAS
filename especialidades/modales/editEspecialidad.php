    <div class="modal fade" id="editEspecialidadModal-<?=$fila['especialidad']?>" tabindex="-1" aria-labelledby="editEspecialidadLabel" aria-hidden="true">
                            ...
                            <div class="col-lg">
                                <div class="form-group">
                                    <form class="row center" action="especialidades/especialidadesCRUD.php" method="post">
                                        <h3 class="d-flex justify-content-center">Editar Especialidad</h3>
